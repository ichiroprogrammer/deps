# Sample Code
## C++
### example/deps/app/src/deps_opts.cpp
```cpp
          1 #include <getopt.h>
          2 
          3 #include <cassert>
...
### example/deps/app/ut/deps_opts_ut.cpp
```cpp
...
### example/deps/dependency/h/dependency/deps_scenario.h
```cpp
          1 #pragma once
          2 #include <memory>
          3 #include <string>
...
### example/deps/dependency/src/arch_pkg.cpp
```cpp
          1 #include <cassert>
          2 #include <sstream>
          3 
...
### example/deps/dependency/src/arch_pkg.h
```cpp
          1 #pragma once
          2 
...
### example/deps/dependency/src/cpp_deps.cpp
```cpp
          1 #include <algorithm>
          2 #include <cassert>
          3 #include <memory>
...
### example/deps/dependency/src/cpp_deps.h
```cpp
          1 #pragma once
          2 #include <compare>
          3 #include <vector>
...
### example/deps/dependency/src/cpp_dir.cpp
```cpp
          1 #include <cassert>
          2 #include <sstream>
          3 #include <tuple>
...
### example/deps/dependency/src/cpp_dir.h
```cpp
          1 #pragma once
          2 #include <iostream>
          3 #include <string>
...
### example/deps/dependency/src/cpp_src.cpp
```cpp
          1 #include <cassert>
          2 #include <fstream>
          3 #include <regex>
...
### example/deps/dependency/src/cpp_src.h
```cpp
          1 #pragma once
          2 #include <string>
          3 #include <utility>
...
### example/deps/dependency/src/deps_scenario.cpp
```cpp
          1 #include <cassert>
          2 #include <iostream>
          3 #include <regex>
...
### example/deps/dependency/src/load_store_format.cpp
```cpp
          1 #include <cassert>
          2 #include <iostream>
          3 #include <regex>
...
### example/deps/dependency/src/load_store_format.h
```cpp
          1 #pragma once
          2 #include <optional>
          3 #include <utility>
...
### example/deps/dependency/ut/arch_pkg_ut.cpp
```cpp
          1 #include "gtest_wrapper.h"
          2 
...
### example/deps/dependency/ut/cpp_deps_ut.cpp
```cpp
          1 #include "gtest_wrapper.h"
          2 
          3 #include "cpp_deps.h"
...
### example/deps/dependency/ut/cpp_dir_ut.cpp
```cpp
          1 #include "gtest_wrapper.h"
          2 
          3 #include "cpp_dir.h"
...
### example/deps/dependency/ut/cpp_src_ut.cpp
```cpp
          1 #include "gtest_wrapper.h"
          2 
          3 #include "cpp_src.h"
...
### example/deps/dependency/ut/deps_scenario_ut.cpp
```cpp
          1 #include <sstream>
          2 
...
### example/deps/dependency/ut/load_store_format_ut.cpp
```cpp
          1 #include "gtest_wrapper.h"
          2 
...
### example/deps/file_utils/h/file_utils/load_store.h
```cpp
          1 #pragma once
          2 #include <fstream>
          3 #include <optional>
...
### example/deps/file_utils/h/file_utils/load_store_row.h
```cpp
          1 #pragma once
          2 #include <fstream>
          3 #include <optional>
...
### example/deps/file_utils/h/file_utils/path_utils.h
```cpp
          1 #pragma once
...
### example/deps/file_utils/src/load_store_row.cpp
```cpp
          1 #include <cassert>
          2 #include <iostream>
          3 #include <optional>
...
### example/deps/file_utils/src/path_utils.cpp
```cpp
          1 #include <algorithm>
          2 #include <sstream>
          3 #include <utility>
...
### example/deps/file_utils/ut/load_store_row_ut.cpp
```cpp
          1 #include "gtest_wrapper.h"
          2 
          3 #include "file_utils/load_store.h"
...
### example/deps/file_utils/ut/path_utils_ut.cpp
```cpp
          1 #include "gtest_wrapper.h"
          2 
          3 #include "file_utils/load_store.h"
...
### example/deps/lib/ut/nstd_ut.cpp
```cpp
...
### example/deps/logging/h/logging/logger.h
```cpp
          1 #pragma once
          2 
          3 #include <fstream>
...
### example/deps/logging/src/logger.cpp
```cpp
...
### example/deps/logging/ut/logger_ut.cpp
```cpp
          1 #include <filesystem>
          2 
          3 #include "gtest_wrapper.h"
...
### example/deps/dependency/CMakeLists.txt
```
          1 cmake_minimum_required(VERSION 3.10)
          2 
...
### example/deps/file_utils/CMakeLists.txt
```
          1 cmake_minimum_required(VERSION 3.10)
          2 
...
### example/deps/lib/CMakeLists.txt
```
          1 cmake_minimum_required(VERSION 3.10)
          2 
...
### example/deps/logging/CMakeLists.txt
```
