...
TEST(path_utils, Logger) {
  ...
  auto exp = std::optional<std::vector<std::string>>{
      LoadFromFile(log_file_org, Load_Strings)};
  ASSERT_TRUE(exp);

  auto act = std::optional<std::vector<std::string>>{
      LoadFromFile(log_file_act, Load_Strings)};
  ASSERT_TRUE(act);
...
TEST(path_utils, GenFilename2Path) {
  auto const act_srcs =
      Paths_t{"ut_data/app1/a_1_c.c", "ut_data/app1/a_1_c.h",
  ...
  auto const exp = Filename2Path_t{
      {"a_1_c.c", "ut_data/app1/a_1_c.c"},
      {"a_1_c.h", "ut_data/app1/a_1_c.h"},
      {"a_1_cpp.cpp", "ut_data/app1/a_1_cpp.cpp"},
      {"a_1_cpp.h", "ut_data/app1/a_1_cpp.h"},
...
TEST(path_utils, AssginSrcsToDirs) {
  ...
  }
  {
    ...
    auto const exp_srcs =
        Paths_t{"path_utils.cpp", "ut_data/app1/mod1/mod1_1.cpp",
                "ut_data/app1/mod1/mod1_1.hpp"};
...
TEST(path_utils, PackageSrcMatcher3) {
  auto const exp_dirs = Paths_t{"ut_data/app1/mod2/mod2_1",
                                "ut_data/app1/mod2/mod2_2", "ut_data/app2"};
  ...
  auto const exp = Dirs2Srcs_t{
      ...
      {"ut_data/app2", {"ut_data/app2/b_1.cpp", "ut_data/app2/b_1.h"}},
      {"no_package",
       {"ut_data/app1/a_1_c.c", "ut_data/app1/mod1/mod1_1.cpp",
        "ut_data/app1/mod1/mod1_1.hpp", "ut_data/app1/mod1/mod1_2.hpp",
        "ut_data/app1/mod2/mod2_1.cpp", "ut_data/app1/mod2/mod2_1.hpp"}},
  };
...
TEST(path_utils, ToString_Paths) {
  auto const exp_srcs =
      Paths_t{"ut_data/app1/a_1_c.c", "ut_data/app1/mod1/mod1_1.cpp",
              "ut_data/app1/mod2/mod2_1/mod2_1_1.cpp",
