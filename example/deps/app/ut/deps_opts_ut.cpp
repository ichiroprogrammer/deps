...
TEST(deps_args, DepsOpts) {
  ...
  {
    char *const argv[]{prog,        cmd_p, opt_recursive, opt_out,
                       opt_out_arg, dir0,  dir1,          dir2};
  ...
  {
    char *const argv[] = {prog,        cmd_p, opt_src_pkg, opt_out,
                          opt_out_arg, dir0,  dir1,        dir2};
  ...
  {
    char *const argv[]{prog,        cmd_s, opt_src_pkg, opt_out,
                       opt_out_arg, dir0,  dir1,        dir2};
  ...
  {
    char *const argv[]{prog,       cmd_p2s,     opt_R,     opt_in,
                       opt_in_arg, opt_exclude, opt_e_arg, dir0};
  ...
  {
    char *const argv[]{prog,       cmd_p2s, opt_s,     opt_in,
                       opt_in_arg, opt_e,   opt_e_arg, dir0};
  ...
  {
    char *const argv[]{prog,       cmd_a2pu, opt_in,
                       opt_in_arg, opt_out,  opt_out_arg};
  ...
  {
    char *const argv[]{prog,    cmd_p,       opt_recursive,
                       opt_out, opt_out_arg, opt_help};
