...
TEST(cpp_src, CppSrc) {
  ...
  auto const exp_incs2 = Paths_t{
      "ut_data/app1/a_1_cpp.h", "ut_data/app1/mod1/mod1_1.hpp",
...
TEST(cpp_src, GenCppSrc) {
  ...
  auto const [act_dirs, act_srcs] = GetCppDirsSrcs({"ut_data/app1"});
  auto const db = FileUtils::GenFilename2Path(act_srcs);
  auto const srcs = Paths_t{"ut_data/app1/a_1_c.c", "ut_data/app1/a_1_c.h",
  ...
  Paths_t const exp_incs[]{
      {"ut_data/app1/a_1_c.h", "ut_data/app1/a_1_cpp.h",
  ...
  for (auto it_act = cpp_srcs_act.cbegin(); it_act != cpp_srcs_act.cend();
       ++it_act) {
...
TEST(cpp_src, GetCppDirsSrcs) {
...

  {
    ...
    auto const [act_dirs, act_srcs] =
        GetCppDirsSrcs({"./ut_data/app1", "ut_data/app2///"});
