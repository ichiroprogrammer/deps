...
TEST(load_store_format, Paths_t) {
  ...
  auto const dir_in = Paths_t{"ut_data/app1", "ut_data/app1/mod1",
                              "ut_data/app1/mod2/mod2_1", "ut_data/app2"};
  ...
  auto dir_out0 =
      std::optional<Paths_t>{FileUtils::LoadFromFile(pkg_org, Load_Paths)};
  ASSERT_TRUE(dir_out0);

  auto dir_out1 =
      std::optional<Paths_t>{FileUtils::LoadFromFile(pkg_act, Load_Paths)};
...
TEST(load_store_format, Dirs2Srcs_t) {
  ...
  const auto dir2srcs_in = FileUtils::Dirs2Srcs_t{
      {"ut_data",
       {"ut_data/app1/a_1_c.c", "ut_data/app1/a_1_c.h",
        "ut_data/app1/a_1_cpp.cpp", "ut_data/app1/a_1_cpp.h",
        "ut_data/app1/a_2_c.C", "ut_data/app1/a_2_c.H",
        "ut_data/app1/a_2_cpp.cxx", "ut_data/app1/a_2_cpp.hpp",
        "ut_data/app1/a_3_cpp.cc", "ut_data/app1/mod1/mod1_1.cpp",
        "ut_data/app1/mod1/mod1_1.hpp", "ut_data/app1/mod1/mod1_2.hpp"}},
      {"ut_data/app1/mod2",
       {"ut_data/app1/mod2/mod2_1.cpp", "ut_data/app1/mod2/mod2_1.hpp"}},
  ...
  // ディレクトリなのでエラーなはず
  ASSERT_FALSE(
      FileUtils::StoreToFile("ut_data/app1", dir2srcs_in, StoreToStream));

  ASSERT_TRUE(
      FileUtils::StoreToFile(dirs2srcs_act, dir2srcs_in, StoreToStream));
...
DepRels_t const dep_rels{
    ...
    {DepRelation{"ut_data/app1", 0, Paths_t{}, "ut_data/app1/mod2", 0,
                 Paths_t{}}},
    {DepRelation{"ut_data/app1", 0, Paths_t{}, "ut_data/app1/mod2/mod2_1", 0,
                 Paths_t{}}},
    ...
    {DepRelation{"ut_data/app1/mod1", 1,
                 Paths_t{"ut_data/app1/mod2/mod2_1.hpp"}, "ut_data/app1/mod2",
                 0, Paths_t{}}},
    {DepRelation{"ut_data/app1/mod1", 0, Paths_t{}, "ut_data/app1/mod2/mod2_1",
                 0, Paths_t{}}},
    {DepRelation{"ut_data/app1/mod1", 1,
                 Paths_t{"ut_data/app1/mod2/mod2_2/mod2_2_1.h"},
                 "ut_data/app1/mod2/mod2_2", 0, Paths_t{}}},
    {DepRelation{"ut_data/app1/mod1", 0, Paths_t{}, "ut_data/app2", 2,
                 Paths_t{"ut_data/app1/mod1/mod1_1.hpp",
                         "ut_data/app1/mod1/mod1_2.hpp"}}},
    {DepRelation{"ut_data/app1/mod2", 0, Paths_t{}, "ut_data/app1/mod2/mod2_1",
                 0, Paths_t{}}},
    {DepRelation{"ut_data/app1/mod2", 0, Paths_t{}, "ut_data/app1/mod2/mod2_2",
                 0, Paths_t{}}},
    {DepRelation{"ut_data/app1/mod2", 0, Paths_t{}, "ut_data/app2", 0,
                 Paths_t{}}},
    {DepRelation{"ut_data/app1/mod2/mod2_1", 1,
                 Paths_t{"ut_data/app1/mod2/mod2_2/mod2_2_1.h"},
                 "ut_data/app1/mod2/mod2_2", 2,
                 Paths_t{"ut_data/app1/mod2/mod2_1/mod2_1_1.h"}}},
    {DepRelation{"ut_data/app1/mod2/mod2_1", 0, Paths_t{}, "ut_data/app2", 0,
                 Paths_t{}}},
    {DepRelation{"ut_data/app1/mod2/mod2_2", 0, Paths_t{}, "ut_data/app2", 0,
                 Paths_t{}}},
};
} // namespace
...
TEST(load_store_format, DepRels_t) {
  ...
  auto deps_out0 =
      std::optional<DepRels_t>{FileUtils::LoadFromFile(deps_org, Load_DepRels)};
  ...
  auto deps_out1 =
      std::optional<DepRels_t>{FileUtils::LoadFromFile(deps_act, Load_DepRels)};
