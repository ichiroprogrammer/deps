...
TEST(arch_pkg, ArchPkgSimple3) {
  ...
  auto exp = std::string{"package  :A:CYCLIC\n"
                         "fullname :A\n"
                         "parent   :TOP\n"
                         "depend_on: {\n"
                         "    B : STRAIGHT\n"
...
TEST(arch_pkg, ToPlantUML_Rectangle) {
  {
    auto const arch = ArchPkg::GenArch(dep_rels_simple);
    auto const exp = std::string{"rectangle \"A\" as A\n"
                                 "rectangle \"B\" as B"};
...
TEST(arch_pkg, ToPlantUML_Rectangle2) {
  ...
  auto const exp = std::string{
      ...
      "ut_data___app1___mod1 \"1\" -[#orange]-> "
      "ut_data___app1___mod2___mod2_2\n"
      "ut_data___app2 \"2\" -[#green]-> ut_data___app1___mod1\n"
      "ut_data___app1___mod2___mod2_1 \"1\" <-[#red]-> \"2\" "
      "ut_data___app1___mod2___mod2_2"};
...
TEST(arch_pkg, FindArchPkg3) {
  ...
  {
    ArchPkg const *pkg_mod2_1_f =
        FindArchPkgByFullName(arch, "ut_data/app1/mod2/mod2_1");
