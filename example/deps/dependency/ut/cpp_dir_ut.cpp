...
TEST(cpp_dir, GenCppDirs) {
  ...
  auto a_1_cpp =
      std::find_if(cpp_dirs.begin(), cpp_dirs.end(), [](CppDir const &pkg) {
        return pkg.Path() == "a_1_cpp.cpp";
      });
  ASSERT_NE(a_1_cpp, cpp_dirs.end());

  auto a_1_cpp_h =
      std::find_if(cpp_dirs.begin(), cpp_dirs.end(),
                   [](CppDir const &pkg) { return pkg.Path() == "a_1_cpp.h"; });
  ASSERT_NE(a_1_cpp_h, cpp_dirs.end());

  auto mod2_2_1_h =
      std::find_if(cpp_dirs.begin(), cpp_dirs.end(), [](CppDir const &pkg) {
        return pkg.Path() == "mod2_2_1.h";
      });
  ASSERT_NE(mod2_2_1_h, cpp_dirs.end());

  auto ret_a_1_cpp =
      std::pair<uint32_t, Paths_t>{a_1_cpp->DependsOn(*a_1_cpp_h)};
  ASSERT_EQ(0, ret_a_1_cpp.first);

  auto ret_mod2_2_1_h =
      std::pair<uint32_t, Paths_t>{mod2_2_1_h->DependsOn(*a_1_cpp_h)};
...
TEST(cpp_dir, CppDir) {
  ...
  auto mod1 = CppDir{"ut_data/app1/mod1",
                     GenCppSrc(packagae_srcs.at("ut_data/app1/mod1"), db)};
  auto app2 =
      CppDir{"ut_data/app2", GenCppSrc(packagae_srcs.at("ut_data/app2"), db)};
...
TEST(cpp_dir, operator_eq_tl) {
  ...
  auto mod1_0 = CppDir{"ut_data/app1/mod1",
                       GenCppSrc(packagae_srcs.at("ut_data/app1/mod1"), db)};
  auto mod1_1 = CppDir{"ut_data/app1/mod1",
                       GenCppSrc(packagae_srcs.at("ut_data/app1/mod1"), db)};
  auto app2 =
      CppDir{"ut_data/app2", GenCppSrc(packagae_srcs.at("ut_data/app2"), db)};
