...
TEST(deps_scenario, PkgGenerator) {
  ...
  {
    auto pg = PkgGenerator{"ut_data/load_store/pkg_org", true,
                           Paths_t{"ut_data/app3/"}, ""};
    auto exp = std::string{"#dir\n"
                           "ut_data/app1\n"
                           "ut_data/app1/mod1\n"
                           "ut_data/app1/mod2\n"
...
TEST(deps_scenario, PkgGenerator2) {
  ...
  {
    auto pg =
        PkgGenerator{"", false, Paths_t{"ut_data/app1", "ut_data/app2"}, ""};
    auto exp = std::string{"#dir\n"
                           "ut_data/app1\n"
                           "ut_data/app2\n"};
  ...
  {
    auto pg =
        PkgGenerator{"", true, Paths_t{"ut_data/app1", "ut_data/app2"}, ""};
    auto exp = std::string{"#dir\n"
                           "ut_data/app1\n"
                           "ut_data/app1/mod1\n"
                           "ut_data/app1/mod2\n"
  ...
  try {
    auto pg = PkgGenerator{"", true,
                           Paths_t{"ut_data/app1/a_1_c.c", "ut_data/app2"}, ""};
...
TEST(deps_scenario, SrcsGenerator) {
...

  {
    auto sg = SrcsGenerator{
        "", true,
        Paths_t{"ut_data/app1/mod2/mod2_1", "ut_data/app1/mod2/mod2_2"}, ""};
...
TEST(deps_scenario, Pkg2SrcsGenerator) {
  ...
  try {
    auto p2sg = Pkg2SrcsGenerator{"ut_data/app1/a_1_c.c", false, false,
                                  Paths_t{"ut_data/app3/"}, ""};
  } catch (std::runtime_error const &e) {
    exception_occured = true;
...
TEST(deps_scenario, Pkg2SrcsGenerator2) {
...

  {
    ...
    auto p2sg = Pkg2SrcsGenerator{"ut_data/load_store/dirs2srcs_org", true,
                                  false, Paths_t{}, ""};
  ...
  }
  {
    ...
    auto const dirs =
        Paths_t{"ut_data", "ut_data/app1/mod2", "ut_data/app1/mod2/mod2_1",
  ...
  }
  {
    ...
    auto const exp = std::string{"#dir2srcs\n"
                                 "ut_data/app1\n"
                                 "    ut_data/app1/a_1_c.c\n"
                                 "    ut_data/app1/a_1_c.h\n"
                                 "    ut_data/app1/a_1_cpp.cpp\n"
...
TEST(deps_scenario, Pkg2PkgGenerator) {
  ...
  auto exception_occured = false;
  try {
    auto p2pg = Pkg2PkgGenerator{"ut_data/app1/a_1_c.c", false, false,
                                 Paths_t{"ut_data/app3/"}, ""};
  } catch (std::runtime_error const &e) {
    exception_occured = true;
    ASSERT_STREQ("ut_data/app1/a_1_c.c is illegal", e.what());
...
TEST(deps_scenario, ArchGenerator) {
...

  {
    ...
    auto act =
        std::optional<std::vector<std::string>>{FileUtils::Load_Strings(ss)};

    auto exp = std::optional<std::vector<std::string>>{FileUtils::LoadFromFile(
        "ut_data/load_store/arch_org", FileUtils::Load_Strings)};
