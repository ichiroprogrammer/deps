...
public:
  explicit PkgGenerator(std::string const &in, bool recursive,
...
public:
  explicit Pkg2SrcsGenerator(std::string const &in, bool recursive,
                             bool src_as_pkg,
                             FileUtils::Paths_t const &dirs_opt,
                             std::string const &pattern);
  virtual bool Output(std::ostream &os) const override;
...
public:
  explicit Pkg2PkgGenerator(std::string const &in, bool recursive,
                            bool src_as_pkg, FileUtils::Paths_t const &dirs_opt,
                            std::string const &pattern);
  virtual bool Output(std::ostream &os) const override;
